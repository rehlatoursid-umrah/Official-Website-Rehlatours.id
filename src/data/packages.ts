...
export const packagesData: Record<string, Package> = {
  'ekonomi-9-hari': {
    ...
    badge: 'Hemat',
    description:
      'Paket umroh terjangkau dengan fasilitas standar untuk perjalanan spiritual yang berkesan. Ideal untuk jamaah yang mengutamakan nilai terbaik dengan budget terbatas.',
    highlights: [
    ...
    included: {
      accommodation: 'Hotel bintang 3 dekat Masjidil Haram & Masjid Nabawi',
      meals: 'Makan 3x sehari (buffet halal)',
      transportation: 'Bus AC, pesawat ekonomi class',
      guidance: 'Pembimbing berpengalaman & materi manasik',
      documentation: 'Visa umroh, passport assistance',
      extras: ['Tas koper', 'Buku doa', 'Air zam-zam 5L'],
    },
    features: [
      { name: 'Hotel dekat Haram', included: true },
      { name: 'Makan 3x sehari', included: true },
      { name: 'Transportasi AC', included: true },
      { name: 'Bimbingan manasik', included: true },
      { name: 'City tour Madinah', included: false },
      { name: 'Upgrade kamar', included: false },
    ],
    departureSchedule: [
      { month: 'Februari 2024', dates: ['15', '22'], available: true },
      { month: 'Maret 2024', dates: ['8', '15', '29'], available: true },
      { month: 'April 2024', dates: ['5', '19'], available: true },
    ],
    groupSize: { min: 35, max: 45 },
    rating: 4.5,
    reviewCount: 89,
    isPopular: true,
  },
...
export const featuredPackages: Package[] = [
  packagesData['reguler-12-hari'], // Most popular
  packagesData['ekonomi-9-hari'], // Budget friendly
  packagesData['premium-14-hari'], // Premium experience
  packagesData['vip-16-hari'], // Luxury
]
